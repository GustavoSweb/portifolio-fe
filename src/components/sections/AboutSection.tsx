...
export default function AboutSection() {
  ...
  return (
    <section ref={containerRef} className="w-full relative bg-bg">
      <div className="content-wrap pb-[160px]">
        <div className="relative grid grid-cols-[800fr_800fr] min-h-[504px]">
          {/* ── Left: dark green panel ── */}
          <div className="relative flex flex-col justify-end p-4 bg-bg border border-teal">
          ...
          <div className="relative flex flex-col overflow-hidden bg-orange p-16">
            <div className="flex">
          ...
          <div className="about-circle pointer-events-none absolute -bottom-[147px] left-1/2 -translate-x-1/2 w-[294px] h-[294px] z-10">
